...
| 5 | taiko CLI | Phase 3 | CLI | Local binary / npm | [x] Built — `cli/`, 4 command groups (`network`, `node`, `bridge`, `contract`), 24/24 tests pass | [plans/taiko-cli.md](plans/taiko-cli.md) |
