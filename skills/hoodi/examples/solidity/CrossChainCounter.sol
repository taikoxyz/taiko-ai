...
/// @dev Deploy on both L1 (Hoodi) and L2 (Taiko Hoodi) with each other's address
///
/// This example shows:
...
///
/// Deployment:
/// 1. Deploy on L2 (Taiko Hoodi) with L1 bridge address
/// 2. Deploy on L1 (Hoodi) with L2 bridge address
...
contract CrossChainCounter {
    ...
    // Chain IDs
    uint64 public constant L1_CHAIN_ID = 560048; // Hoodi
    uint64 public constant L2_CHAIN_ID = 167013; // Taiko Hoodi
