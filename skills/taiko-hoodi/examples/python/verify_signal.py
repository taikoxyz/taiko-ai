#!/usr/bin/env python3
"""
Example: Verify a signal was sent on Taiko Hoodi using merkle proofs.
...
# Taiko Hoodi configuration
RPC = "https://rpc.hoodi.taiko.xyz"
CHAIN_ID = 167013

# SignalService address on Taiko Hoodi L2
SIGNAL_SERVICE = "0x1670130000000000000000000000000000000005"


def rpc_call(method: str, params: list) -> dict:
    """Make a JSON-RPC call to the Taiko Hoodi RPC."""
...
def main():
    ...
    print("Signal Verification Example for Taiko Hoodi")
    print("=" * 50)
    print(f"RPC: {RPC}")
    ...
    bridge_address = "0x1670130000000000000000000000000000000001"
